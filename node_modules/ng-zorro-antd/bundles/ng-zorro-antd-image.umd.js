(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ng-zorro-antd/core/config'),require('@angular/cdk/overlay'),require('@angular/common'),require('@angular/cdk/drag-drop'),require('ng-zorro-antd/icon'),require('@angular/cdk/bidi'),require('@angular/cdk/portal'),require('ng-zorro-antd/pipes'),exports, require('@angular/cdk/bidi'), require('@angular/common'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('ng-zorro-antd/core/config'), require('ng-zorro-antd/core/util'), require('@angular/cdk/overlay'), require('@angular/cdk/portal'), require('@angular/cdk/keycodes'), require('ng-zorro-antd/core/animation'), require('@angular/cdk/drag-drop'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/pipes')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/image', ['@angular/core','ng-zorro-antd/core/config','@angular/cdk/overlay','@angular/common','@angular/cdk/drag-drop','ng-zorro-antd/icon','@angular/cdk/bidi','@angular/cdk/portal','ng-zorro-antd/pipes','exports', '@angular/cdk/bidi', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators', 'ng-zorro-antd/core/config', 'ng-zorro-antd/core/util', '@angular/cdk/overlay', '@angular/cdk/portal', '@angular/cdk/keycodes', 'ng-zorro-antd/core/animation', '@angular/cdk/drag-drop', 'ng-zorro-antd/icon', 'ng-zorro-antd/pipes'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngZorroAntd.core.config,global.ng.cdk.overlay,global.ng.common,global.ng.cdk.dragDrop,global.ngZorroAntd.icon,global.ng.cdk.bidi,global.ng.cdk.portal,global.ngZorroAntd.pipes,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].image = {}), global.ng.cdk.bidi, global.ng.common, global.ng.core, global.rxjs, global.rxjs.operators, global['ng-zorro-antd'].core.config, global['ng-zorro-antd'].core.util, global.ng.cdk.overlay, global.ng.cdk.portal, global.ng.cdk.keycodes, global['ng-zorro-antd'].core.animation, global.ng.cdk.dragDrop, global['ng-zorro-antd'].icon, global['ng-zorro-antd'].pipes));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6,ɵngcc7,ɵngcc8,exports, bidi, common, core, rxjs, operators, config, util, overlay, portal, keycodes, animation, dragDrop, icon, pipes) { 
var _c0 = ["*"];
var _c1 = ["imgRef"];
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzImageGroupComponent, [{
    ...
    var NzImagePreviewRef = /** @class */ (function () {
        function NzImagePreviewRef(previewInstance, config, overlayRef) {
            ...
            overlayRef
                .keydownEvents()
                .pipe(operators.filter(function (event) { return _this.config.nzKeyboard && event.keyCode === keycodes.ESCAPE && !keycodes.hasModifierKey(event); }))
    ...
    var NzImagePreviewComponent = /** @class */ (function () {
        ...
        Object.defineProperty(NzImagePreviewComponent.prototype, "maskClosable", {
            get: function () {
                var _a, _b;
                var defaultConfig = this.nzConfigService.getConfigForComponent(NZ_CONFIG_MODULE_NAME$1) || {};
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzImagePreviewComponent, [{
    ...
    var NzImageService = /** @class */ (function () {
        ...
        NzImageService.prototype.createOverlay = function (config) {
            var _a, _b;
            var globalConfig = this.nzConfigService.getConfigForComponent(NZ_CONFIG_MODULE_NAME$1) || {};
    ...
    var NzImageDirective = /** @class */ (function () {
        ...
        NzImageDirective.prototype.onPreview = function () {
            ...
            if (this.parentGroup) {
                ...
                var previewImages = previewAbleImages.map(function (e) { return ({ src: e.nzSrc, srcset: e.nzSrcset }); });
                ...
                var previewImages = [{ src: this.nzSrc, srcset: this.nzSrcset }];
        ...
        NzImageDirective.prototype.backLoad = function () {
            ...
            if (this.backLoadImage.complete) {
                ...
                this.backLoadImage.onload = function () {
                    ...
                    _this.getElement().nativeElement.srcset = _this.nzSrcset;
                };
                this.backLoadImage.onerror = function () {
                    _this.status = 'error';
                    if (_this.nzFallback) {
                        _this.getElement().nativeElement.src = _this.nzFallback;
                        _this.getElement().nativeElement.srcset = '';
                    }
                };
            }
        };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzImageModule, [{
    ...
    exports.NZ_CONFIG_MODULE_NAME = NZ_CONFIG_MODULE_NAME$1;
