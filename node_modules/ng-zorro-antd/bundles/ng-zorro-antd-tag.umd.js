(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/cdk/bidi'),require('@angular/common'),require('ng-zorro-antd/icon'),require('@angular/forms'),exports, require('@angular/cdk/bidi'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('ng-zorro-antd/core/color'), require('ng-zorro-antd/core/util'), require('@angular/common'), require('@angular/forms'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/tag', ['@angular/core','@angular/cdk/bidi','@angular/common','ng-zorro-antd/icon','@angular/forms','exports', '@angular/cdk/bidi', '@angular/core', 'rxjs', 'rxjs/operators', 'ng-zorro-antd/core/color', 'ng-zorro-antd/core/util', '@angular/common', '@angular/forms', 'ng-zorro-antd/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.cdk.bidi,global.ng.common,global.ngZorroAntd.icon,global.ng.forms,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].tag = {}), global.ng.cdk.bidi, global.ng.core, global.rxjs, global.rxjs.operators, global['ng-zorro-antd'].core.color, global['ng-zorro-antd'].core.util, global.ng.common, global.ng.forms, global['ng-zorro-antd'].icon));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, bidi, core, rxjs, operators, color, util, common, forms, icon) { 
    ...
    ***************************************************************************** */
    ...
    var NzTagComponent = /** @class */ (function () {
        ...
        NzTagComponent.prototype.clearPresetColor = function () {
            ...
            // /(ant-tag-(?:pink|red|...))/g
            var regexp = new RegExp("(ant-tag-(?:" + __spreadArray(__spreadArray([], __read(color.presetColors)), __read(color.statusColors)).join('|') + "))", 'g');
            ...
            (_b = hostElement.classList).remove.apply(_b, __spreadArray([], __read(matches)));
        };
        /**
         * @deprecated
         * move to host after View Engine deprecation
