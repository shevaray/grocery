    ...
    ***************************************************************************** */
    ...
    var NzMNContainerComponent = /** @class */ (function () {
        ...
        NzMNContainerComponent.prototype.create = function (data) {
            ...
            this.instances = __spreadArray(__spreadArray([], __read(this.instances)), [instance]);
            this.readyInstances();
            return instance;
        };
        NzMNContainerComponent.prototype.remove = function (id, userAction) {
            ...
            this.instances.some(function (instance, index) {
                if (instance.messageId === id) {
                    ...
                    _this.instances = __spreadArray([], __read(_this.instances));
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzMessageService, [{
    ...
    NzMessageService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function NzMessageService_Factory() { return new NzMessageService(i0__namespace.ɵɵinject(i1__namespace.NzSingletonService), i0__namespace.ɵɵinject(i2__namespace.Overlay), i0__namespace.ɵɵinject(i0__namespace.INJECTOR)); }, token: NzMessageService, providedIn: NzMessageServiceModule });
