    ...
    var NzAggregatePipe = /** @class */ (function () {
        ...
        NzAggregatePipe.prototype.transform = function (value, method) {
            ...
            switch (method) {
                ...
                case 'max':
                    return Math.max.apply(Math, __spreadArray([], __read(value)));
                case 'min':
                    return Math.min.apply(Math, __spreadArray([], __read(value)));
                default:
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzBytesPipe, [{
    ...
    var NzToCssUnitPipe = /** @class */ (function () {
        ...
        NzToCssUnitPipe.prototype.transform = function (value, defaultUnit) {
            ...
            var percentagesUnit = ['%'];
            var listOfUnit = __spreadArray(__spreadArray(__spreadArray([], __read(absoluteLengthUnit)), __read(relativeLengthUnit)), __read(percentagesUnit));
            var unit = 'px';
